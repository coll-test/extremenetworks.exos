...
from ansible_collections.extremenetworks.exos.plugins.modules import exos_command
...
class TestExosCommandModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.extremenetworks.exos.plugins.modules.exos_command.run_commands')
