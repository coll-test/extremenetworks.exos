...
from ansible_collections.extremenetworks.exos.tests.unit.compat.mock import patch
from ansible_collections.extremenetworks.exos.tests.unit.modules.utils import set_module_args
from ansible.module_utils.common._collections_compat import Mapping
from ansible_collections.extremenetworks.exos.plugins.modules import exos_facts
...
class TestExosFactsModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.extremenetworks.exos.plugins.module_utils.network.exos.facts.legacy.base.run_commands')
